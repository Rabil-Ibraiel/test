              ...
              {click && (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: parties.find((p) => p.abbr === click)
                        ?.color,
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `linear-gradient(0deg, ${
                        parties.find((p) => p.abbr === click)?.color
                      }, color-mix(in oklab, ${
                        parties.find((p) => p.abbr === click)?.color
                      } 88%, white))`,
                    }}
                  >
                    <h4 className="flex items-baseline lg:gap-2 md:gap-1 gap-0.5">
                      <p className="digits font-eloquia lg:text-2xl text-lg font-bold mr-1">
                        {parties.find((p) => p.abbr === click)?.thisElecChairs}
                      </p>
                      <span className="font-bold">مقعدا</span>
                    </h4>
                    <p className="digits font-eloquia lg:lg:text-2xl text-lg font-bold mr-1.5">
                      2025
                    </p>
                  </div>
                  ...
                  {/* Divider */}
                  <div
                    className="divider w-2 h-full bg-white"
                    style={{
                      backgroundImage: `linear-gradient(0deg, ${
                        parties.find((p) => p.abbr === click)?.color
                      }, color-mix(in oklab, ${
                  ...
                  >
                    <h4 className="flex items-baseline lg:gap-2 md:gap-1 gap-0.5">
                      <p className="digits font-eloquia lg:text-2xl text-lg font-bold">
                        {parties.find((p) => p.abbr === click)?.lastElecChairs}
                      </p>
                      <span className="font-bold">مقعدا</span>
                    </h4>
